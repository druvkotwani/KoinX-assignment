...
const About = () => {
    return (
        <div className=" bg-white rounded-md px-2 font-sans pb-2 ">
            ...
            <p className=' text-base pt-2'>Bitcoin is a decentralized digital currency, without a central bank or single administrator, that can be sent from user to user on the peer-to-peer bitcoin network without the need for intermediaries.</p>

            <h2 className='font-semibold text-lg pt-4 '>Who created Bitcoin?</h2>
            ...
            <p className='text-base pt-2'>Conventional currencies are based on gold or silver. Theoretically, you knew that if you handed over a dollar at the bank, you could get some gold back (although this didn’t actually work in practice). But bitcoin isn’t based on gold; it’s based on mathematics.</p>
