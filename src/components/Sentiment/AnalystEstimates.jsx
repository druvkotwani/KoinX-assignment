    ...
    return (
        <div className=' my-2'>
            <div className='flex items-center justify-start gap-1 '>
                <h1 className='font-semibold text-xl pl-2 text-[#44465a]'>Analyst Estimates</h1>
                <InfoIcon />
            </div>
                ...
                <div className='text-[#737d8d] flex flex-col gap-4 '>
                    ...
                    <div className='flex justify-start items-center  gap-2'>
                        ...
                        <div className='flex justify-center items-center gap-2 '>
                            <div className='bg-[#15b179] w-28 h-[10px]  rounded-sm   text-[#15b179]'></div>
                            <span>76%</span>
                        </div>
                    </div>
                    <div className='flex justify-start items-center  gap-2'>
                        ...
                        <div className='flex justify-center items-center gap-2 '>
                            <div className='bg-[#c7c9cf] w-8 h-[10px]  rounded-sm   '></div>
                            <span>8%</span>
                        </div>
                    </div>
                    ...
                    <div className='flex justify-start items-center  gap-2'>
                        ...
                        <div className='flex justify-center items-center gap-2 '>
                            <div className='bg-[red] w-12 h-[10px]  rounded-sm   '></div>
                            <span>16%</span>
                        </div>
                    </div>
